...
2 上面的Class.extend方法可以变一下，添加一个Class.create方法，这样类实例化的时候，就以下面的形式直接调用
...
应用实例： 
1 class-obj.js  参数为object 但是是一个对象字面量object  {key:value}
2 class-fun.js  参数也为object 但是是new 一个匿名构造函数, new function(){}
*/
